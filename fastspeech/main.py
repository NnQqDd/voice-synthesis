...
fastspeech2 = FastSpeech2.from_hparams(source="speechbrain/tts-fastspeech2-ljspeech", run_opts={"device":"cuda"})
hifi_gan = HIFIGAN.from_hparams(source="speechbrain/tts-hifigan-ljspeech", run_opts={"device":"cuda"})
...
# Save the waverform
torchaudio.save('speech.wav', waveforms.squeeze(1), 22050)
print('Done!')