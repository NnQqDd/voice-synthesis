...
decoder = None
def convert(args):
    global encoder, encoder_lf0, encoder_spk, decoder
    ...
    out_filename = f"vqmivc-{args.index:03d}.wav"
    with torch.no_grad():
...
if __name__ == "__main__":
    ...
    for idx, source_audio in enumerate(source_audios):
        ...
        args.source_wav = source_audio
        args.reference_wav = '../reference_audio.wav'
        args.converted_wav_path = '../voice-conversion-audios'
        args.model_path = 'models/checkpoints/useCSMITrue_useCPMITrue_usePSMITrue_useAmpTrue/VQMIVC-model.ckpt-500.pt'
        args.index = idx
        convert(args)
