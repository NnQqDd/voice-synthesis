...
if __name__ == '__main__':
    ...
    for idx, source_audio in enumerate(source_audios):    
        args = Namespace()
        args.source = source_audio
        args.target = '../reference_audio.wav'
        args.output = f'../voice-conversion-audios/avc-{idx:03d}.wav'
        args.sample_rate = 24000
        inferencer.reload(args)
