...
def convert(args):
    ...
    source_file_list = source_file_list[:200] 
    print(f"Number of source utterances: {len(source_file_list)}.")
    
    total_rtf = 0.0
    cnt = 0
    for idx, src_wav_path in tqdm(enumerate(source_file_list)):
        ...
        if '/bilstm/' in args.ppg2mel_model_file:
            wav_fname = f"{output_dir}/bilstm_vc-{idx:03d}.wav"
        else:
            wav_fname = f"{output_dir}/ppg_vc-{idx:03d}.wav"
...
def main():
    ...
    args.src_wav_dir = "/home/duyn/ActableDuy/datasets/VCTK/VCTK-Corpus/VCTK-Corpus/wav48/p225"
    args.ref_wav_path = "../reference_audio.wav"
    # args.ppg2mel_model_train_config = "/home/duyn/ActableDuy/voice-synthesis/ppg-vc/model/seq2seq_mol_ppg2mel_vctk_libri_oneshotvc_r4_normMel_v2.yaml"
    # args.ppg2mel_model_file = "/home/duyn/ActableDuy/voice-synthesis/ppg-vc/model/best_loss_step_304000.pth"
    args.ppg2mel_model_train_config = "/home/duyn/ActableDuy/voice-synthesis/ppg-vc/bilstm/bilstm_ppg2mel_vctk_libri_oneshotvc.yaml"
    args.ppg2mel_model_file = "/home/duyn/ActableDuy/voice-synthesis/ppg-vc/bilstm/step_250000.pth"
    args.output_dir = "/home/duyn/ActableDuy/voice-synthesis/voice-conversion-audios"
